  ...
  stages {
    ...
    steps {
        ...
        withEnv([
            ...
            docker build -t helijay/recipe-streaming-backend-nodejs:latest .
            docker push helijay/recipe-streaming-backend-nodejs:latest
            docker build -t helijay/recipe-streaming-frontend:latest ./html
            docker push helijay/recipe-streaming-frontend:latest
            docker logout
            '''
        }
        }
